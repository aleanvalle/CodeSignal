namespace AbsoluteValuesSumMinimization.Test
{
    public class UnitTest1
    {
        AbsoluteValuesSumMinimization.Program absoluteValuesSumMinimization;

        public UnitTest1()
        {
            absoluteValuesSumMinimization = new AbsoluteValuesSumMinimization.Program();
        }
        ...
        public void Test1()
        {
            int[] a = { 2, 4, 7 };
            int expectedValue = 4;
            int actualValue = absoluteValuesSumMinimization.AbsoluteValuesSumMinimization(a);
